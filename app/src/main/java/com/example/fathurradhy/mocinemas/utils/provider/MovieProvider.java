package com.example.fathurradhy.mocinemas.utils.provider;
...
import static com.example.fathurradhy.mocinemas.utils.db.DatabaseContract.AUTHORITY;
import static com.example.fathurradhy.mocinemas.utils.db.DatabaseContract.CONTENT_URI;
import static com.example.fathurradhy.mocinemas.utils.db.DatabaseContract.TABLE_MOVIE;
...
public class MovieProvider extends ContentProvider {
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        Log.d("URISEMPAI", "Masuk");
        Log.d("URISEMPAI", uri.toString());
